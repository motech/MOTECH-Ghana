...
function addFacility() {
    ...
    var hideAdditionalPhones = function() {
        $j('#additional-phone1').hide();
        $j('#additional-phone2').hide();
        $j('#additional-phone3').hide();
        $j('#additional-phone4').hide();
    }
    ...
    var bind = function() {
        ...
        $j('#addPhone1').click(addPhoneOne)
        $j('#addPhone2').click(addPhoneTwo)
        $j('#addPhone3').click(addPhoneThree)
        $j('#addPhone4').click(addPhoneFour)
    };

    var addPhoneOne = function() {
        $j('#addPhone1').hide();
        $j('#additional-phone1').show();
    }

    var addPhoneTwo = function() {
        $j('#addPhone2').hide();
        $j('#additional-phone2').show();
    }

    var addPhoneThree = function() {
        $j('#addPhone3').hide();
        $j('#additional-phone3').show();
    }

    var addPhoneFour = function() {
        $j('#addPhone4').hide();
        $j('#additional-phone4').show();
    }
