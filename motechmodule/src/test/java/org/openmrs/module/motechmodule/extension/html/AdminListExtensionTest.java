 ...
 */
package org.openmrs.module.motechmodule.extension.html;
...
import org.openmrs.module.motechmodule.extension.html.AdminList;
...
public class AdminListExtensionTest extends TestCase {
	...
	public void testValidatesLinks() {
		...
		assertTrue("There should be a positive number of links", links.values()
				.size() > 0);
	}
	...
	public void testMediaTypeIsHtml() {
		...
		assertTrue("The media type of this extension should be html", ext
				.getMediaType().equals(MEDIA_TYPE.html));
	}
