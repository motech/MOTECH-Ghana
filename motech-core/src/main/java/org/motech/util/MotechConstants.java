...
public final class MotechConstants {
	...
	public static final String LOCATION_DEFAULT_GHANA_CLINIC = "Default Ghana Clinic";
	...
	public static final String CONCEPT_PREGNANCY_VISIT_NUMBER = "PREGNANCY VISIT NUMBER";
	public static final String CONCEPT_INTERMITTENT_PREVENTATIVE_TREATMENT = "INTERMITTENT PREVENTATIVE TREATMENT";
	public static final String CONCEPT_INSECTICIDE_TREATED_NET_USAGE = "INSECTICIDE TREATED NET USAGE";
	public static final String CONCEPT_PENTA_VACCINATION = "PENTA VACCINATION";
	...
	public static final String CONCEPT_PRE_PREVENTING_MATERNAL_TO_CHILD_TRANSMISSION = "PRE PREVENTING MATERNAL TO CHILD TRANSMISSION";
	...
	public static final String CONCEPT_REGIMEN_START = "REGIMEN_START";
	public static final String CONCEPT_REGIMEN_END = "REGIMEN_END";
